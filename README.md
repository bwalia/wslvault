...
| **[Getting started](docs/GETTING-STARTED.md)** | **Step-by-step setup and sign-in, written for any reader** |
| [Onboarding a tenant](docs/operations/onboarding-a-tenant.md) | The same ground for engineers, with the API detail |
