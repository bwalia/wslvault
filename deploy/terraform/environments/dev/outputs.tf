###############################################################################
# WSLVault — Dev Environment Outputs
###############################################################################
...
output "database_endpoint" {
  description = <<-EOT
    Connection endpoint for the RDS PostgreSQL instance in the format
    <host>:<port>.  The full credentials are stored in Secrets Manager
    (see db_secret_arn).
  EOT
